...
*  Or on VS2019
* `cmake -G "Visual Studio 16 2019" -DBUILD_UNIT_TESTS=ON -DCMAKE_BUILD_TYPE=Release ..`
*  Open generated `sph-sdk.sln` and run `Build Solution` in MSVC 2017 or 2019 IDE

### Add these three lines to MarchingCubes.cpp
* #include <algorithm>
* #include <iterator>
* #include <set>
