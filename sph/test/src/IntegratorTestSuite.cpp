...
{
    ParticleVect particles = { Particle(SPHAlgorithms::Point2D(0., 1.), 0.1) };
    particles[0].density = 0.5;
    particles[0].fTotal = SPHAlgorithms::Point2D(0.25, 0.25);
    particles[0].acceleration = SPHAlgorithms::Point2D(0.1, 0.1);
